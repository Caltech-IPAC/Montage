...
Summary:  Install all the Python version you want to support.  Then execute
"run.sh" in this directory.  The bulk of this write-up are technical notes
...
is 14.1 (Sonoma) and the version used for the Python distribution is 11.1
(Big Sur).  So all our compilation is done with 11.1, using an environment
variable that controls the CLANG compiler:
